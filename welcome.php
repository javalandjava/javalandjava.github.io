...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="http://java/home.php"><b>Գլխավոր էջ</b></a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-left">
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="welcome.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Ինքնաստուգման հարցեր<span class="sr-only">(current)</span></a></li>
            <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>> <a href="welcome.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Պատմություն</a></li>
            
            
        </ul>
        <ul class="nav navbar-nav navbar-right">
        <li <?php echo''; ?> > <a href="logout.php?q=welcome.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Դուրս գալ</a></li>
        </ul>
            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        <center><h1 class="title" style="color:#660033">Արդյունք</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            $r=$row['sahi'];
                            $qa=$row['level'];
                            echo '<tr style="color:#66CCFF"><td>Հարցերի քանակը</td><td>'.$qa.'</td></tr>
                                <tr style="color:#99cc32"><td>Ճիշտ պատասխանների քանակըr&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td><td>'.$r.'</td></tr> 
                                <tr style="color:red"><td>Սխալ պատասխանների քանակը&nbsp;<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></td><td>'.$w.'</td></tr>
                                <tr style="color:#66CCFF"><td>Միավորները&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
                        }
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><td><center><b>Թ․ Հ</b></center></td><td><center><b>Թեմա</b></center></td><td><center><b>Պատասխանների քանակ</b></center></td><td><center><b>Ճիշտ</b></center></td><td><center><b>Սխալ<b></center></td><td><center><b>Միավորներ</b></center></td>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
